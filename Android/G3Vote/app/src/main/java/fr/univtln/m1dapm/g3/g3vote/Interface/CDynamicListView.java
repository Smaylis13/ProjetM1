 ...
 */
public class CDynamicListView extends ListView {

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;

    public ArrayList<CCandidate> mCandidateList;
    ...
    public CDynamicListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public CDynamicListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        CStableArrayAdapter adapter = ((CStableArrayAdapter)getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mCandidateList, originalItem, getPositionForView(switchView));
    ...
    public void setCandidateList(ArrayList<CCandidate> pCandidateList) {
        mCandidateList = pCandidateList;
    }
