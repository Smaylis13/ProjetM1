...
public class CUserAdapter extends BaseAdapter{
    ...
    //constructeur
    public CUserAdapter(Context context, List<CUser> listUser){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            layoutItem = (RelativeLayout) mInflater.inflate(R.layout.user_layout, parent, false);
        } else {
