...
CREATE TABLE GROUPE (ID_GROUPE INT  AUTO_INCREMENT NOT NULL,
NOM_GROUPE VARCHAR(20),
DESCRIPTION_GROUPE LONGTEXT,
...
CREATE TABLE PARTICIPE (ID_VOTE INT  AUTO_INCREMENT NOT NULL,
