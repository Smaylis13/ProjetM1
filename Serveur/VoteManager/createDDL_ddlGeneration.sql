...
CREATE TABLE vote (ID_VOTE INTEGER AUTO_INCREMENT NOT NULL, DATE_DEBUT_VOTE DATETIME, DATE_FIN_VOTE DATETIME, DESCRIPTION_VOTE VARCHAR(255), STATUT_VOTE TINYINT(1) default 0, NOM_VOTE VARCHAR(255), ID_UTILISATEUR INTEGER, ID_TYPE INTEGER, PRIMARY KEY (ID_VOTE))
...
CREATE TABLE regle (ID_REGLE INTEGER AUTO_INCREMENT NOT NULL, DESCRIPTION_REGLE VARCHAR(255), NOM_REGLE VARCHAR(255), PRIMARY KEY (ID_REGLE))
